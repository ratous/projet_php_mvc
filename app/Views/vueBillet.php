...
// Depuis la version 4.4 de Codeigniter les options de sécurité demandent 
// de spécifier une route pour chaque type de données
// Il est donc indispensable d'utiliser le getdata déclaré dans le fichier routes
// getdata correspond à la fonction index de votre controleur
// les données get y seront alors transmises
//==========================================================================
//==========================================================================
echo '<a href="getdata?action=retour">Website</a>'
?>
</body>
</html>